...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { artist: @painting.artist, description: @painting.description, gallery_id: @painting.gallery_id, image: @painting.image, price: @painting.price, title: @painting.title }
    end
  ...
  test "should update painting" do
    put :update, id: @painting, painting: { artist: @painting.artist, description: @painting.description, gallery_id: @painting.gallery_id, image: @painting.image, price: @painting.price, title: @painting.title }
    assert_redirected_to painting_path(assigns(:painting))
  end
